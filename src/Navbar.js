...
const navigation = [
  ...
  { name: 'Clinics', href: '/clinic', current: true },
  { name: 'Services', href: '/services', current: false },
  { name: 'Reviews', href: './review', current: false },
  { name: 'My Appointments', href: '/form', current: false },
]
...
export default function Navbar() {
  return (
    <Disclosure as="nav" className="bg-pink nav1">
      {({ open }) => (
        <>
            ...
            <div className="relative flex h-16 items-center justify-between">
              ...
              <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                ...
                <Menu as="div" className="relative ml-3">
                  ...
                  >
                    <Menu.Items className="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-pink text-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                      <Menu.Item>
                        {({ active }) => (
                          <a
                            href="/profile"
